...
if __name__ == "__main__":
    ...
    # Utilis to check answers scores
    ...
    # Utilis to check RAGAS score on different answers
    ...
    # Utilis to print the results

    #"mutation_frame1", "mutation_frame2", "mutation_frame3", "mutation_frame4", "mutation_frame5", "mutation_text1", "mutation_text2", "mutation_text3", "mutation_text4", "mutation_text5"
    files = ["mutation_frame1", "mutation_frame3", "mutation_frame4", "mutation_frame5", "mutation_text1", "mutation_text4", "mutation_text5", "mutation_text3"]
    files = []
    #for file in files:
