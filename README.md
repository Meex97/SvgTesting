...
Inside the folder "MIST-HRI" it is possible to find all the testing tools created to test the faulty system, validate the LLM-as-a-judge, prompt used in during the project and results