...
def get_dialogue_answer_states(question):
    response = ""
...
def test_same(question, metamorphed_questions, n = 3, domain = True):
    print(question)
    ...
    if domain:
        ...
        test_case_answer = get_dialogue_answer_states(question)
    ...
    for meta in metamorphed_questions:
        if domain:
            ...
            follow_up = get_dialogue_answer_states(meta)
